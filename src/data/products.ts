 ...
 * ─────────────────────────────────────────────────────────────────────────
 *  These are the FACTORY's certifications, not FastForm's, and the wording is
 *  deliberately attributed that way. Do NOT reword this to imply FastForm
...
export const products: Product[] = [
  {
    ...
    specs: [
      ...
      { label: "Printer Model", value: "DeskFab X1" },
      ...
      { label: "Software", value: "FastForm slicing & control software" },
    ...
    images: ["/products/ff-desk.jpg"],
    printedParts: ["/products/ff-desk-part-1.jpg", "/products/ff-desk-part-2.jpg"],
  ...
  },
  {
    ...
    specs: [
      { label: "Process", value: "SLM (Selective Laser Melting)" },
      { label: "Product Model", value: "FF-M140" },
    ...
    images: ["/products/ff-m140.jpg"],
    printedParts: ["/products/ff-m140-part-1.jpg", "/products/ff-m140-part-2.jpg"],
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Product Model", value: "FF-M220" },
    ...
    images: ["/products/ff-m220.jpg"],
    printedParts: ["/products/ff-m220-part-1.jpg", "/products/ff-m220-part-2.jpg"],
  ...
  },
  {
    ...
    images: ["/products/ff-m300.jpg"],
    printedParts: ["/products/ff-m300-part-1.jpg", "/products/ff-m300-part-2.jpg"],
  ...
  },
  {
    ...
    images: ["/products/ff-m420.jpg"],
    printedParts: ["/products/ff-m420-part-1.jpg", "/products/ff-m420-part-2.jpg"],
  ...
  },
  {
    ...
    images: ["/products/ff-m800.jpg"],
    printedParts: ["/products/ff-m800-part-1.jpg", "/products/ff-m800-part-2.jpg"],
...

  {
    ...
    inquiryOnly: true,
    description:
      "A green-laser system built for one job most metal printers cannot do: copper. Copper reflects the infrared light conventional fiber lasers use, which is why it is so difficult to print well. The AiForm-G1 runs a single-mode green fiber laser that copper actually absorbs — so you get dense, fully-fused parts instead of porous ones. That unlocks the geometry thermal engineers have always wanted but could never cast or machine: internal lattice cold plates, conformal liquid-cooling channels, and heat exchangers with walls down to 0.1 mm. With a 15–40 µm beam and scene-intelligent focusing, it holds micro-level detail across the whole build. Aimed squarely at data-center liquid cooling, power electronics, and aerospace thermal management — and, like every FastForm machine, it runs FastForm and is supported by our Americas team.",
    highlights: [
      ...
      "Runs FastForm slicing & control, like the rest of the lineup",
    ],
    compliance: PRINTER_COMPLIANCE,
    specs: [
      { label: "Process", value: "SLM (Selective Laser Melting)" },
      { label: "Printer Model", value: "AiForm-G1" },
      ...
      { label: "Software", value: "FastForm slicing & control suite" },
      {
        label: "Printable Materials",
    ...
    images: ["/products/ff-g1.jpg"],
    printedParts: ["/products/ff-g1-part-1.jpg"],
    featured: true,
  },

  {
    // Third-party listing — the atomizer stays an Envishon product (see
    // `thirdParty`). It closes the loop for the printer line: make your own
    // powder, then print it. Unconfirmed figures (per-model dimensions/weight)
    // are intentionally NOT published — see public/products/Atomizer/SOURCE.md.
    slug: "en-atomizer",
    name: "EN-Atomizer",
    ...
    inquiryOnly: true,
    description:
      "Make your own feedstock. The EN-Atomizer melts precious metal and atomizes it into fine, spherical powder in a single one-key cycle — so your SLM and MIM work stops waiting on the powder market. Gold, K-gold, silver, copper and custom alloys all run on the same machine, with particle size adjustable from 80# down to 400#. It's built for small, high-purity batches: melting runs at up to 1600–2200 °C with ±1 °C control under a nitrogen or argon blanket and full vacuum to keep the powder clean, while a Siemens PLC with a POKA-YOKE foolproof system runs the cycle end to end. Available from a 4 kg benchtop vacuum unit up to a 100 kg floor-standing production system — sold and supported by Envishon.",
    highlights: [
      ...
      "High purity — vacuum + inert-gas blanketing keeps cross-contamination out",
      "Adjustable particle size — 80#–200# and 300#–400# grit ranges from one machine",
      "One-key operation with a POKA-YOKE foolproof system",
    ...
    specs: [
      { label: "Process", value: "Vacuum melting & atomization" },
      { label: "Models", value: "EN-A4 / EN-A8 / EN-A30 / EN-A50 / EN-A100" },
      { label: "Gold Capacity", value: "4 / 8 / 30 / 50 / 100 kg" },
      { label: "Max Temperature", value: "1600 °C / 2200 °C" },
      { label: "Temperature Accuracy", value: "±1 °C" },
      {
        label: "Particle Grit",
        value: "80#, 100#, 200# adjustable (80#–200#, 300#–400#)",
      },
      { label: "Melting Time", value: "3–5 min (4 kg) to 20–30 min (100 kg)" },
      { label: "Power Supply", value: "380 V, 50/60 Hz, three phase" },
      { label: "Rated Power", value: "15 kW – 50 kW (by model)" },
      { label: "Suitable Materials", value: "K-gold, gold, silver, copper, alloys" },
      {
        label: "Operation",
        value: "One-key full cycle; POKA-YOKE foolproof system",
      },
      { label: "Control System", value: "Siemens PLC + Weinview touch-screen" },
      { label: "Inert Gas", value: "Nitrogen / argon" },
      { label: "Vacuum", value: "High-quality vacuum pump, -100 kPa" },
      { label: "Cooling", value: "Water chiller (sold separately)" },
    ],
    images: ["/products/en-atomizer.jpg"],
    thirdParty: {
      brand: "Envishon",
      site: "envishon3d.com",
      url: "https://envishon3d.com/platforms/en-atomizer",
      logo: "/brand/en-emblem.png",
    },
  },
